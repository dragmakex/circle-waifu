...
const updatedLabel = (todo: Todo): string => {
  const dt = todo.updatedAt
  const yyyy = String(DateTime.getPartUtc("year")(dt))
  const mm = String(DateTime.getPartUtc("month")(dt)).padStart(2, "0")
  const dd = String(DateTime.getPartUtc("day")(dt)).padStart(2, "0")
  const hh = String(DateTime.getPartUtc("hour")(dt)).padStart(2, "0")
  const min = String(DateTime.getPartUtc("minute")(dt)).padStart(2, "0")
  const ss = String(DateTime.getPartUtc("second")(dt)).padStart(2, "0")
