...
export default defineConfig({
  ...
  jsPlugins: [
    ...
    { name: "linteffect-port", specifier: "./oxlint-linteffect-plugin.cjs" },
  ],
  rules: {
    ...
    "linteffect-port/no-effect-as": "error",
    "linteffect-port/no-effect-bind": "error",
    "linteffect-port/no-effect-do": "error",
    "linteffect-port/no-effect-async": "error",
    "linteffect-port/no-effect-never": "error",
    "linteffect-port/no-runtime-runfork": "error",
    "linteffect-port/prevent-dynamic-imports": "error",
    "linteffect-port/no-effect-call-in-effect-arg": "error",
    "linteffect-port/no-nested-effect-gen": "error",
    "linteffect-port/no-effect-all-step-sequencing": "error",
    "linteffect-port/no-return-in-callback": "error",
